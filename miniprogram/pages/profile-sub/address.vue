...
const redirectUrl = ref('/pages/profile-sub/address')
...
const ensureAuth = (options: any) => {
  redirectUrl.value = buildRedirectUrl('/pages/profile-sub/address', options || {})
  if (isLoggedIn()) {
    return true
  }
...
const handleAdd = () => {
  uni.navigateTo({
    url: '/pages/profile-sub/address-edit'
  })
}

const handleEdit = (address: any) => {
  uni.navigateTo({
    url: `/pages/profile-sub/address-edit?id=${address.id}`
  })
}

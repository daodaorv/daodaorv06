...
const redirectUrl = ref('/pages/business/campsite/booking');
...
const ensureAuth = (options: any) => {
  redirectUrl.value = buildRedirectUrl('/pages/business/campsite/booking', options || {});
  if (isLoggedIn()) {
    return true;
  }
...
const rentDatePickerRef = ref<any>(null);

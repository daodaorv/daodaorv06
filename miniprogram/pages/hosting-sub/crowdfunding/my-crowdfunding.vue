...
const goToProjectDetail = (id: string) => {
  uni.navigateTo({
    url: `/pages/hosting-sub/crowdfunding/project-detail?id=${id}`
  })
}
...
const viewIncome = (projectId: string) => {
  uni.navigateTo({
    url: `/pages/hosting-sub/crowdfunding/income-detail?projectId=${projectId}`
  })
}
...
const sellShare = (projectId: string) => {
  uni.navigateTo({
    url: `/pages/hosting-sub/crowdfunding/sell-share?projectId=${projectId}`
  })
}
...
const goToSelfUseBooking = (projectId: string) => {
  uni.navigateTo({
    url: `/pages/hosting-sub/crowdfunding/self-use-booking?projectId=${projectId}`
  })
}
...
const viewShareDetail = (projectId: string) => {
  uni.navigateTo({
    url: `/pages/hosting-sub/crowdfunding/project-detail?id=${projectId}`
  })
}
...
const goToBrowse = () => {
  uni.navigateTo({
    url: '/pages/hosting-sub/crowdfunding/projects'
  })
}
...
const goToMarket = () => {
  uni.navigateTo({
    url: '/pages/hosting-sub/crowdfunding/share-market'
  })
}
</script>

<template>
  <div class="vehicle-insurance-container">
    ...
    <div class="page-header">
      <h2>保险管理</h2>
      <p class="page-description">管理车辆保险记录、理赔记录和续保提醒</p>
    </div>
      ...
      <el-col :span="6">
        <el-card shadow="hover" class="stat-card">
          <div class="stat-content">
            ...
            <div class="stat-info">
              <div class="stat-value">{{ stats.activeInsurance }}</div>
      ...
      <el-col :span="6">
        <el-card shadow="hover" class="stat-card">
          <div class="stat-content">
            ...
            <div class="stat-info">
              <div class="stat-value">{{ stats.expiringInsurance }}</div>
      ...
      <el-col :span="6">
        <el-card shadow="hover" class="stat-card">
          <div class="stat-content">
            ...
            <div class="stat-info">
              <div class="stat-value">{{ stats.expiredInsurance }}</div>
      ...
      <el-col :span="6">
        <el-card shadow="hover" class="stat-card">
          <div class="stat-content">
            ...
            <div class="stat-info">
              <div class="stat-value">¥{{ stats.totalPremium.toLocaleString() }}</div>
      ...
      <el-form :model="searchForm" inline>
        ...
        <el-form-item label="保险类型">
          ...
          >
            ...
            <el-option label="组合险" value="combined" />
          </el-select>
        </el-form-item>
    ...
    <el-card class="toolbar-card" shadow="never">
      ...
      <el-button :icon="Document" @click="handleViewClaims">理赔记录</el-button>
      <el-button :icon="Bell" @click="handleViewRenewals">续保提醒</el-button>

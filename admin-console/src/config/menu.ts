...
export const menuConfig: MenuItem[] = [
...

  {
    ...
    children: [
      ...
      {
        path: '/crowdfunding/vehicles',
        name: 'CrowdfundingVehicles',
        meta: { title: '车辆关联' },
      },
      {
        path: '/crowdfunding/shares',
        name: 'CrowdfundingShares',
        meta: { title: '份额管理' },
      },
      {
        path: '/crowdfunding/trades',
        name: 'CrowdfundingTrades',
        meta: { title: '份额交易' },
      },
    ],
  },
...

  {
    ...
    children: [
      {
        path: '/profit-sharing/crowdfunding',
        name: 'ProfitSharingCrowdfunding',
        meta: { title: '众筹分润' },
      },
      {
